    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  Proton-qt [" + tr("command-line options") + "]                     " + "\n";
...
PrivateSend uses an Protontive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 Proton, 0.1 Proton, 1 Proton and 10 Proton -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nlcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://Protoncoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
