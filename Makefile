...
pkgdatadir = $(datadir)/protoncore
pkgincludedir = $(includedir)/protoncore
pkglibdir = $(libdir)/protoncore
pkglibexecdir = $(libexecdir)/protoncore
...
CONFIG_HEADER = $(top_builddir)/src/config/proton-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/proton-config.h.in \
...
ACLOCAL = ${SHELL} /home/NLCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/NLCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/NLCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/NLCoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = proton-cli
BITCOIN_DAEMON_NAME = protond
BITCOIN_GUI_NAME = proton-qt
BITCOIN_TX_NAME = proton-tx
...
COPYRIGHT_HOLDERS_FINAL = The Proton Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Proton Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/NLCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = protoncore
PACKAGE_BUGREPORT = https://github.com/protoncoin/protoncoin/issues
PACKAGE_NAME = Proton Core
PACKAGE_STRING = Proton Core 2.0.0
PACKAGE_TARNAME = protoncore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/NLCoin
abs_srcdir = /home/NLCoin
abs_top_builddir = /home/NLCoin
abs_top_srcdir = /home/NLCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/NLCoin/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/protond$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/proton-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/proton-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Proton-Qt.app
OSX_DMG = Proton-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_proton_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_proton_coverage.info test_proton.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Proton-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/proton-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/proton-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/proton-config.h
$(top_srcdir)/src/config/proton-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/proton-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Proton-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Proton-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Proton-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Proton-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_proton.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_proton -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_proton_filtered.info: test_proton.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_proton_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_proton_filtered.info
...
#test_proton_coverage.info: baseline_filtered_combined.info test_proton_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_proton_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_proton_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_proton_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_proton.coverage/.dirstamp:  test_proton_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_proton.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_proton.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
