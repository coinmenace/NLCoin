...
Only requiring some minor changes is Proton.cpp.
...
Changes to Proton.cpp
----------------------
Proton.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
